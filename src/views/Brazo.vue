<template>
  <q-page class="gym-bg q-pa-lg">
    ...
    <div class="text-center q-mb-xl">
      ...
      <div class="text-h3 text-weight-bold text-white q-mt-sm">Rutina de Brazo</div>
...
const ejercicios = ref([
  { nombre: 'Curl de Biceps 21', equipo: 'Barra', reps: '4 x 12', media: '/biceps1.mp4', timer: 0, maxTime: 60, interval: null, isStarted: false, isCompleted: false },
  { nombre: 'Behind the Back Curl (Cable)', equipo: 'Maquina', reps: '4 x 15', media: '/biceps2.mp4', timer: 0, maxTime: 60, interval: null, isStarted: false, isCompleted: false },
  { nombre: 'Curl Martillo', equipo: 'Mancuernas', reps: '3 x 12', media: '/biceps3.mp4', timer: 0, maxTime: 60, interval: null, isStarted: false, isCompleted: false },
  { nombre: 'Fondos en banco', equipo: 'Mancuerna', reps: '3 al fallo', media: '/biceps4.mp4', timer: 0, maxTime: 60, interval: null, isStarted: false, isCompleted: false }
])
...
const checkRoutineCompletion = () => {
  if (completedCount.value === ejercicios.value.length) {
    $q.dialog({
      ...
      message: '¡Excelente trabajo! Has completado todos los ejercicios de brazo.',
      persistent: true,
