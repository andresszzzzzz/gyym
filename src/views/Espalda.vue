<template>
  <q-page class="gym-bg q-pa-lg">
    ...
    <div class="text-center q-mb-xl">
      ...
      <div class="text-h3 text-weight-bold text-white q-mt-sm">Rutina de Espalda</div>
          ...
          <div class="row">
            ...
            <div class="col-12 col-md-6 q-pa-lg">
              ...
              <div class="q-gutter-sm q-mb-md">
                ...
                <q-chip color="deep-orange" text-color="white" icon="fitness_center">{{ ej.principal }}</q-chip>
...
const ejercicios = ref([
  { nombre: 'Remo Inclinado (Mancuerna)', equipo: 'Mancuernas', principal: 'Dorsal Ancho', reps: '4 x 12', media: '/espalda1.mp4', timer: 0, maxTime: 60, interval: null, isStarted: false, isCompleted: false },
  { nombre: 'Remo Gorila (Pesa Rusa)', equipo: 'Pesa Rusa', principal: 'Dorsal Ancho', reps: '3 x 10', media: '/espalda2.mp4', timer: 0, maxTime: 60, interval: null, isStarted: false, isCompleted: false },
  { nombre: 'Extensión de Espalda (Hiperextensión)', equipo: 'Banco', principal: 'Espalda Baja', reps: '3 x 15', media: '/espalda3.mp4', timer: 0, maxTime: 60, interval: null, isStarted: false, isCompleted: false },
  { nombre: 'Superman', equipo: 'Peso corporal', principal: 'Espalda Baja', reps: '4 x 15', media: '/espalda4.mp4', timer: 0, maxTime: 60, interval: null, isStarted: false, isCompleted: false }
])
...
const checkRoutineCompletion = () => {
  if (completedCount.value === ejercicios.value.length) {
    $q.dialog({
      ...
      message: '¡Excelente trabajo! Has completado todos los ejercicios de espalda.',
      persistent: true,
